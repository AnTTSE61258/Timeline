...
$(document).ready(function() {
    ...
    $('.mmenu_opt').click(function() {
      $('#mmenu').css('visibility', 'visible');
    });
});

//Language Selector
var theLanguage = $('html').attr('lang').toLowerCase();
var lang;
switch (theLanguage) {
  case "pt-br":
    lang = 'pt-br';
...
var language = $('.languages-selector .ul p').find('.' + lang);

language.parent().remove();
language.appendTo('.current-language');
$('.current-language').on('click', '.arrow-down', function(){
  $(this).parent().parent().find('.ul').slideToggle();
});
$('.languages-selector').on('mouseleave', function(){
...
$(".lang-link").on('click', function()
{
    if($(this).hasClass('en-us')) {
        changePreferredLanguage('en-us');
    } else if($(this).hasClass('pt-br')){
        changePreferredLanguage('pt-br');
    } else if($(this).hasClass('ko-kr')){
        changePreferredLanguage('ko-kr');
    } else if($(this).hasClass('th')){
        changePreferredLanguage('th');
    } else if($(this).hasClass('vi')){
        changePreferredLanguage('vi');
    } else if($(this).hasClass('id-id')){
        changePreferredLanguage('id-id');
    } else if($(this).hasClass('it-it')){
        changePreferredLanguage('it-it');
    }
});

function changePreferredLanguage(language){
    document.cookie = "preferred_lang=" + language + ";";
}
